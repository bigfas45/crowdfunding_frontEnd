                                            ...
                                            <div class="card-body">
                                                <form>
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="small mb-1" for="inputLastName">Email    <span>*Case Sensitive</span></label>
                                                                <input  onChange={
                                                                        handleChnage("email")
                                                                    }
                                                                    value={email}
                                                ...
                                                <div className="form-group mb-0">
                                                    {
                                                    loading && loading ? (
                                                        <Button class="btn btn-primary btn-block" variant="success" disabled>
