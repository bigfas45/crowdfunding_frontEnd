...
const asideBar = () => {
    ...
    <div className="ecaps-sidemenu-area">
        ...
        <div className="ecaps-logo">
            <Link to="#"><img className="desktop-logo" src="https://nasdng.com/wp-content/uploads/2020/05/nasdlogop.jpg" alt="Desktop Logo"/> <img className="small-logo" src="http://demo.riktheme.com/litam/side-menu/img/core-img/small-logo.png" alt="Mobile Logo"/></Link>
        </div>
