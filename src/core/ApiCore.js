...
export const verificationMail = (email) => {
    return fetch(`${API}/mail/application/verification/${email}`, {method: "GET"}).then(response => {
        return response.json();
...
export const getProject = (projectId) => {
    return fetch(`${API}/project/read/${projectId}`, {method: "GET"}).then(response => {
        return response.json();
    }).catch(err => console.log(err));
};
...
export const getProjectGallery = (projectId) => {
    return fetch(`${API}/gallery/related/${projectId}`, {method: "GET"}).then(response => {
        return response.json();
    }).catch(err => console.log(err));
};

export const getProjectAll = () => {
    return fetch(`${API}/project/listProject?order=desc&limit=6`, {method: "GET"}).then(response => {
        return response.json();
    }).catch(err => console.log(err));
};
...
export const getIndividualInvestorForm = (userId) => {
    return fetch(`${API}/individual/investor/related/${userId}`, {method: "GET"}).then(response => {
        return response.json();
    }).catch(err => console.log(err));
};

export const getCorporateInvestorForm = (userId) => {
    return fetch(`${API}/corporate/investor/related/${userId}`, {method: "GET"}).then(response => {
        return response.json();
    }).catch(err => console.log(err));
};
